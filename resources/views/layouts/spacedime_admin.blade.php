...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="/">Spacedime designs</a>
        ...
        <div id="layoutSidenav">
                    ...
                    <div class="sb-sidenav-menu">
                        ...
                        <a class="nav-link" href="{{route('admin.index')}}">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link" href="{{route('portfolio.index')}}">View Portfolio</a>
                        ...
                        <a class="nav-link collapsed" href="{{route('quotation.index')}}" >
                            ...
                            <a class="nav-link collapsed" href="{{route('enquiry.index')}}" >
                                <div class="sb-nav-link-icon"><i class="fa fa-columns" aria-hidden="true"></i></div>
                                 Contact
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    ...
                    <div class="text-muted">Copyright &copy; spacedime {{date('Y')}}</div>
                        <div>
